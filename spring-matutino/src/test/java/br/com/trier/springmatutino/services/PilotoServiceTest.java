...
public class PilotoServiceTest extends BaseTests {
	...
	void insertInvalidTest() {
		...
		var exception = assertThrows(ViolacaoIntegridade.class, () -> service.salvar(piloto));
	...
	void updateInvalidTest() {
		...
		assertEquals("Piloto Jessica não encontrado", exception.getMessage());
	}
	...
	void findByEquipeTest() {
		...
		assertEquals("Janaina", pilotos.get(2).getName());
	}
	...
	void findByEquipeNotFoundTest() {
		var exception = assertThrows(ObjetoNaoEncontrado.class, () -> service.findByEquipe(new Equipe(1, "Equipe")));
	...
	void findByNomeContainsIgnoreCaseOrderByNomeTest() {
		...
		assertEquals("Gustavo", pilotos.get(0).getName());
	}
	...
	void findByNomeContainsIgnoreCaseOrderByNomeNotFoundTest() {
		var exception = assertThrows(ObjetoNaoEncontrado.class, () -> service.findByNameContainsIgnoreCaseOrderByName("qualquer"));
	...
	void findByPaisNotFoundTest() {
		var exception = assertThrows(ObjetoNaoEncontrado.class, () -> service.findByPais(new Pais(2, "Africa")));
		assertEquals("Não há pilotos da Africa", exception.getMessage());
	}
